...
"""
import argparse
from dg2cd.data.synthetic_domains import generate_all_domains, synthetic_root
from dg2cd.utils import load_config

def main() -> None:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--config", default="configs/pacs.yaml")
    parser.add_argument("--source", help="source domain; overrides dataset.source")
    ...
    print(f"output    : {synthetic_root(cfg)}\n")
